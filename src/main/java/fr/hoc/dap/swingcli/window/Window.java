...
public class Window extends JFrame implements ActionListener {
    ...
    private static final Integer WINDOW_SIZE_Y = 300;
    /** Default ratio. */
    private static final Integer RATIO = 18;
    /** Instance of email panel. */
    private EmailPanel emailPanel;
    /** Instance of event panel. */
    private EventPanel eventPanel;
    /** Instance of welcome panel. */
    private WelcomePanel welcomePanel;
    /** Instance of menu panel. */
    ...
    public Window() throws Exception {
        ...
        menuPanel.registrerRefresh(this);
        refreshAllPanel();
        setWindowSize();
        this.setLocationRelativeTo(null);
        this.setTitle("Data Acces Project");
    ...
    @Override
    public final void actionPerformed(final ActionEvent refreshAllPanel) {
        refreshAllPanel();
    }
}
