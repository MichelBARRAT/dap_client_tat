 ...
 */
package fr.hoc.dap.swingcli.window;
...
public class EventPanel extends JPanel {
    ...
    public EventPanel() throws Exception {
        ...
        textPanel.add(nbOfEvents);
        textPanel.add(new JLabel(" prochains évenements: "));
    ...
    /**
     * get nbOfEvents instance.
     *
     * @return nbOfEvents instance
     */
    public JTextField getNbOfEvents() {
        return nbOfEvents;
    }

    /**
     * get numberOfEvents instance.
     *
     * @return nbOfEvents
     */
     ...
     *
     * @param newNbOfEvents number of events to display
     */
    public void setNbOfEvents(final JTextField newNbOfEvents) {
        this.nbOfEvents = newNbOfEvents;
    }
}
