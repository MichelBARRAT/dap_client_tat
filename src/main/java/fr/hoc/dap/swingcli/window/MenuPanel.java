...
public class MenuPanel extends JPanel implements ActionListener {
    /** SerialVersionUID. */
    private static final long serialVersionUID = 4810780393804552431L;
    /** Default grid layout X. */
    private static final Integer GRID_LAYOUT_X = 3;
    ...
    /**
     * Constructor build menu panel.
     */
    public MenuPanel() {
        buttonRefresh = new JButton("Refresh");
        buttonOption = new JButton("Options");
        buttonAccount = new JButton("Create Account");
        this.setLayout(new GridLayout(GRID_LAYOUT_X, 1));
